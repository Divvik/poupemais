...
(isset($_POST['c_telefone']) && !empty($_POST['c_telefone']) ? $telefone = ('c_telefone') : $telefone = null);

(isset($_POST['c_email']) && !empty($_POST['c_email']) ? $email = filter_input(INPUT_POST, 'e_email', FILTER_VALIDATE_EMAIL) : $email = null);
...
if(isset($_POST['c_nome']) && !empty($_POST['c_nome'])) {

    $nome = filter_input_post('c_post'); 
    return $nome ;
