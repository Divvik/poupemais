...
-- -----------------------------------------------------
-- Table `db_poupemais`.`tb_nomePlanos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_poupemais`.`tb_nomePlanos` (
  `idNomePlano` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`idNomePlano`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `db_poupemais`.`tb_valorPlano`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_poupemais`.`tb_valorPlano` (
  `idValorPlano` INT NOT NULL AUTO_INCREMENT,
  `valor` DECIMAL(7,2) NOT NULL,
  PRIMARY KEY (`idValorPlano`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_poupemais`.`tb_usuario_invest` (
  ...
  `idNomePlano` INT NOT NULL,
  `idValorPlano` INT NOT NULL,
  PRIMARY KEY (`idInvest`, `idCliente`, `idGrupo`, `idNomePlano`, `idValorPlano`),
  INDEX `fk_tb_usuario_invest_tb_cliente1_idx` (`idCliente` ASC),
  INDEX `fk_tb_usuario_invest_tb_grupos1_idx` (`idGrupo` ASC),
  INDEX `fk_tb_usuario_invest_tb_nomePlanos1_idx` (`idNomePlano` ASC),
  INDEX `fk_tb_usuario_invest_tb_valorPlano1_idx` (`idValorPlano` ASC),
  ...
  CONSTRAINT `fk_tb_usuario_invest_tb_grupos1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_usuario_invest_tb_nomePlanos1`
    FOREIGN KEY (`idNomePlano`)
    REFERENCES `db_poupemais`.`tb_nomePlanos` (`idNomePlano`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_usuario_invest_tb_valorPlano1`
    FOREIGN KEY (`idValorPlano`)
    REFERENCES `db_poupemais`.`tb_valorPlano` (`idValorPlano`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_poupemais`.`confirmation` (
  ...
  INDEX `fk_confirmation_tb_usuario1_idx` (`idUsuario` ASC),
  CONSTRAINT `fk_confirmation_tb_usuario1`
    FOREIGN KEY (`idUsuario`)
    REFERENCES `db_poupemais`.`tb_usuario` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
INSERT INTO tb_usuario (email,senha,login) VALUES ('admin@admin.com',md5('123'),'admin');
    
INSERT INTO tb_usuario (email,senha,login) VALUES ('joãodasilva@gmail.com',md5('123456'),'joao_silva');

/* Inserção tabela cliente */
INSERT INTO tb_cliente (nomeCliente,cpf,rg,estado_civil,endereco,bairro,cep,cidade,estado,telefone,date_cadastro,status,idUsuario) VALUES
					('Elton','111.111.111-11','11.222.333-44','solteiro','Rua vida nova, 34' ,'Vida velha','12345-000','São Paulo','SP','11-99999-9999',2019-05-25,'confirmado',1);

/* Inserção planos */
INSERT INTO tb_nomePlano (nomePlano) VALUES ('6 meses'),('12 meses');
INSERT INTO tb_valorPlano (valorPlano) VALUES (50.00),(100.00),(150.00),(200.00);

/* Inserção Grupos */
INSERT INTO tb_grupos (nomeGrupo) VALUES ('Grupo1'),('Grupo2'),('Grupo3');
