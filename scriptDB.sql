...
CREATE TABLE IF NOT EXISTS `db_poupemais`.`tb_usuario_invest` (
  ...
  PRIMARY KEY (`idInvest`, `idCliente`, `idPlano`),
...
INSERT INTO tb_cliente (nomeCliente,endereco,cpf,cidade,estado,telefone,idUsuario) VALUES 
					('João da Silva','Rua da vida, 30','111.222.333-12','São Paulo','SP','11-9999-9999',1),
				   ('Paulo Afonso','Rua proxima, 30','444.555.666-45', 'Rio de janeiro','RJ','1198888-8888',2);
/* Seleção tabela */
...
INSERT INTO tb_usuario_invest (vencimento,idCliente,idPlano,situacao) VALUES 
	('2019-06-23',1,1,'aberto'),('2019-07-23',1,1,'aberto'),
    ('2019-08-23',1,1,'aberto'),('2019-09-23',1,1,'aberto'),
    ('2019-10-23',1,1,'aberto'),('2019-11-23',1,1,'aberto'),
    ('2019-06-23',2,2,'aberto'),('2019-07-23',2,2,'aberto'),
    ('2019-08-23',2,2,'aberto'),('2019-09-23',2,2,'aberto'),
    ('2019-10-23',2,2,'aberto'),('2019-11-23',2,2,'aberto');
...
INSERT INTO tb_pagamentos (idInvest,idCliente,dataPag) VALUES (1,1,'2019-07-30'), (2,2,'2019-06-30');
/* Seleção tabela */
